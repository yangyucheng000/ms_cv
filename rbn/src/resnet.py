...
class RepresentativeBatchNorm2d(nn.Cell):
    r"""
    ...
    def construct(self, x):
        ...
        x = x + self.center_weight.view(1, self.num_features, 1, 1) * self.stas(x, (2, 3))
        ...
        # return self.gamma.view(1, self.num_features, 1, 1) * output + self.beta.view(1, self.num_features, 1, 1)
